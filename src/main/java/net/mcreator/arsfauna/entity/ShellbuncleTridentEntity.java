...
public class ShellbuncleTridentEntity extends AbstractArrow implements ItemSupplier {
	...
	public ShellbuncleTridentEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(ArsFaunaModEntities.SHELLBUNCLE_TRIDENT.get(), world);
	}
	...
	public ShellbuncleTridentEntity(EntityType<? extends ShellbuncleTridentEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public ShellbuncleTridentEntity(EntityType<? extends ShellbuncleTridentEntity> type, LivingEntity entity, Level world) {
	...
	public static ShellbuncleTridentEntity shoot(LivingEntity entity, LivingEntity target) {
		ShellbuncleTridentEntity entityarrow = new ShellbuncleTridentEntity(ArsFaunaModEntities.SHELLBUNCLE_TRIDENT.get(), entity, entity.level());
