...
public class ShellbuncleTridentEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Items.TRIDENT);
	private int knockback = 0;

	public ShellbuncleTridentEntity(EntityType<? extends ShellbuncleTridentEntity> type, Level world) {
		super(type, world);
	}

	public ShellbuncleTridentEntity(EntityType<? extends ShellbuncleTridentEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public ShellbuncleTridentEntity(EntityType<? extends ShellbuncleTridentEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static ShellbuncleTridentEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		ShellbuncleTridentEntity entityarrow = new ShellbuncleTridentEntity(ArsFaunaModEntities.SHELLBUNCLE_TRIDENT.get(), entity, world, null);
	...
	public static ShellbuncleTridentEntity shoot(LivingEntity entity, LivingEntity target) {
		ShellbuncleTridentEntity entityarrow = new ShellbuncleTridentEntity(ArsFaunaModEntities.SHELLBUNCLE_TRIDENT.get(), entity, entity.level(), null);
