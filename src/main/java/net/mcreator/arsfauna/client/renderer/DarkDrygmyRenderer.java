...
public class DarkDrygmyRenderer extends GeoEntityRenderer<DarkDrygmyEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, DarkDrygmyEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
