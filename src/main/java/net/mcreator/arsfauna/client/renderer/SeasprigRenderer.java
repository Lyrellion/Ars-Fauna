...
public class SeasprigRenderer extends GeoEntityRenderer<SeasprigEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SeasprigEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
