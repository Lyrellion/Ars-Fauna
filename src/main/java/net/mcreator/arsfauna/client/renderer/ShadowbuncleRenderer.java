...
public class ShadowbuncleRenderer extends GeoEntityRenderer<ShadowbuncleEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ShadowbuncleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
