...
public class StarbuncleSwarmRenderer extends GeoEntityRenderer<StarbuncleSwarmEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, StarbuncleSwarmEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
