...
public class CloudbuncleRenderer extends GeoEntityRenderer<CloudbuncleEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, CloudbuncleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
