...
public class FrostbuncleRenderer extends GeoEntityRenderer<FrostbuncleEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FrostbuncleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
