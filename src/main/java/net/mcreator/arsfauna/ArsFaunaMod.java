...
@Mod("ars_fauna")
public class ArsFaunaMod {
	public static final Logger LOGGER = LogManager.getLogger(ArsFaunaMod.class);
	public static final String MODID = "ars_fauna";

	public ArsFaunaMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		ArsFaunaModItems.REGISTRY.register(modEventBus);
		ArsFaunaModEntities.REGISTRY.register(modEventBus);
		ArsFaunaModTabs.REGISTRY.register(modEventBus);

		ArsFaunaModParticleTypes.REGISTRY.register(modEventBus);
